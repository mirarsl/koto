...
class BilgiBankasi extends StatefulWidget {
  const BilgiBankasi({Key? key}) : super(key: key);

  @override
  _BilgiBankasiState createState() => _BilgiBankasiState();
}

class _BilgiBankasiState extends State<BilgiBankasi> {
  dynamic pageData;
  Future<dynamic> loadPage() async {
    pageData = "";
    try {
      var data =
          await Network().getPage('http://koto.org.tr/app_bilgi_bankasi.php');
      pageData = data;
    } catch (e) {
      print(e);
    }
